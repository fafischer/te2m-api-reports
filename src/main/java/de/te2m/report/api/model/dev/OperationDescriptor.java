 ...
 *
 */
package de.te2m.report.api.model.dev;


import de.te2m.report.api.model.GeneratorUtils;
import de.te2m.report.api.model.ManagedDescriptor;
...
public class OperationDescriptor extends ManagedDescriptor {
     ...
     */
    @Override
    public List<de.te2m.report.api.model.mgmt.TaskDescriptor> getAllSubTasks() {
