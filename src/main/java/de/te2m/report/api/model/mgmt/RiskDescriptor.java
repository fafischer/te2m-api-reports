 ...
 *
 */
package de.te2m.report.api.model.mgmt;

import de.te2m.report.api.model.BasicDescriptor;
 ...
 * @author ffi
 */
public class RiskDescriptor extends BasicDescriptor {
    ...
    public static abstract class Builder<T extends Builder<T>> extends BasicDescriptor.Builder<T> {
         ...
         */
        @Override
        public RiskDescriptor build() {
            RiskDescriptor cd = (RiskDescriptor) super.enrich(new RiskDescriptor());
        ...
        public Object enrich(Object obj) {
            if (null != obj && (obj instanceof RiskDescriptor)) {
                RiskDescriptor cd = (RiskDescriptor) super.enrich(((RiskDescriptor) obj));
